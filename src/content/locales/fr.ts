...
export const fr: SiteContent = {
  ...
  ui: {
    ...
    brandHome: 'AVYOR, accueil',
    nav: {
      main: 'Navigation principale',
      mobile: 'Navigation mobile',
      open: 'Ouvrir le menu',
      close: 'Fermer le menu',
      menuTitle: 'Menu AVYOR',
      menuDescription: 'Découvrez le produit et choisissez votre parcours.',
    },
    language: {
      label: 'Langue',
      current: 'Langue actuelle',
      error: 'Changement de langue impossible. Réessayez.',
    },
    download: { app: 'Télécharger l’app', discover: 'Découvrir AVYOR' },
    store: {
      comingSoon: 'Bientôt disponible',
      launching: 'Le lancement se prépare.',
      talk: 'Parlons de votre projet',
      apple: { lead: 'Télécharger sur', name: 'App Store' },
      google: { lead: 'Disponible sur', name: 'Google Play' },
    },
    media: {
      pauseVideo: 'Mettre la vidéo en pause',
      playVideo: 'Lire la vidéo',
      pauseBackground: 'Mettre l’arrière-plan en pause',
      playBackground: 'Lire l’arrière-plan',
      pause: 'Pause',
      play: 'Lire',
    },
    demoCaption:
    ...
    screen: {
      ...
      scenes: {
        '04-feed': 'feed vidéo',
        '02-matching': 'découverte des Creators',
        '03-match-detail': 'compatibilité avec une campagne',
        '05-campaign': 'brief de campagne',
        '06-collaboration': 'conversation de collaboration',
        '07-payment': 'suivi du paiement',
        '08-portfolio': 'portfolio Creator',
      },
    },
    hero: {
      eyebrow: 'LA CRÉATION FAIT LA RENCONTRE',
      title: { lead: ['Le bon Creator.'], accent: ['La bonne', 'campagne.'] },
      description: [
        'Creators et marques, trouvez-vous.',
        'Créez ensemble. Gardez le projet au même endroit.',
      ],
      seeHow: 'Voir comment ça marche',
      tagTop: 'LE TALENT SE VOIT.',
      tagBottom: 'LA RENCONTRE SE CRÉE.',
      explore: 'EXPLORER AVYOR',
    },
    manifesto: {
      eyebrow: 'UNE APP. DEUX UNIVERS. LE MÊME ÉLAN.',
      title: {
        lead: ['Il y a des talents à découvrir.', 'Des histoires à raconter.'],
        accent: ['Et tout ce qui peut naître entre les deux.'],
      },
      body: 'AVYOR réunit Creators et marques dans une application mobile : découvrez les créations, trouvez les bons profils et donnez un cadre à vos collaborations.',
      pillars: [
        ['Découvrir', 'Le feed vidéo et les profils Creator.'],
        ['Créer', 'Modèles guidés, studio et portfolio.'],
        ['Collaborer', 'Brief, messages et livrables.'],
      ],
    },
    audiences: {
      eyebrow: '02 — CHACUN SON UNIVERS',
      title: { lead: ['La création a deux côtés.'], accent: ['AVYOR fait le lien.'] },
      creator: {
        eyebrow: 'CREATORS',
        title: ['Faites parler', 'votre travail.'],
        body: ['Un portfolio pour votre univers.', 'Des campagnes pour la suite.'],
        link: 'Découvrir le parcours Creator',
        alt: 'Visuel de démonstration : création de contenu en extérieur',
      },
      brand: {
        eyebrow: 'MARQUES',
        title: ['Votre histoire.', 'Le bon regard.'],
        body: ['Découvrez un style.', 'Construisez une collaboration.'],
        link: 'Découvrir le parcours marque',
        alt: 'Visuel de démonstration : contenu beauté pour une campagne',
      },
    },
    feed: {
      eyebrow: '03 — VIDEO FIRST. TALENT FIRST.',
      title: { lead: ['Le talent se voit.'], accent: ['Alors, regardez.'] },
      body: 'Un regard, un montage, une façon de raconter. Découvrez ce que les Creators savent faire, directement dans le feed vidéo.',
      note: 'Les créations passent avant les présentations.',
      link: 'Découvrir le feed AVYOR',
    },
    trust: {
      eyebrow: '06 — LE PROJET A UN CADRE',
      title: { lead: ['Tout le projet.'], accent: ['Un seul endroit.'] },
      lead: 'Les échanges font avancer les idées. Des étapes claires font avancer la collaboration.',
      cards: [
        [
          'Le contexte reste.',
      ...
      link: 'Comprendre les paiements et la sécurité',
    },
    story: {
      eyebrow: '01 — LA RENCONTRE, PUIS LE PROJET',
      title: { lead: ['Moins d’outils.'], accent: ['Plus de création.'] },
      lead: 'Du premier regard au projet livré, un fil continu.',
      link: 'Explorer le produit',
      inApp: 'DANS L’APP',
      steps: 'Étapes du produit',
    },
    workflow: {
      eyebrow: '04 — À VOUS DE JOUER',
      title: { lead: ['Deux parcours.'], accent: ['Une même rencontre.'] },
      tabsLabel: 'Votre parcours AVYOR',
      creatorTab: 'Je suis Creator',
      brandTab: 'Je suis une marque',
      creator: [
        [
      ...
      link: 'Le parcours en détail',
    },
    gallery: {
      eyebrow: '05 — LE PRODUIT, SANS DÉTOUR',
      title: { lead: ['Un aperçu.'], accent: ['De vraies possibilités.'] },
      previous: 'Captures précédentes',
      next: 'Captures suivantes',
      region: 'Captures de l’application, utilisez les flèches pour parcourir',
      shots: [
        ...
        [
          '06-collaboration',
          'Le projet garde son fil.',
          'La conversation accompagne la collaboration.',
        ],
        [
          '03-match-detail',
    ...
    faq: {
      eyebrow: 'LES QUESTIONS QUI COMPTENT',
      title: 'On en parle ?',
      lead: 'Un projet commence aussi par les bonnes réponses.',
      link: 'Contacter l’équipe',
    },
    footer: {
      eyebrow: 'LE PROCHAIN PROJET COMMENCE PAR UNE RENCONTRE',
      title: { lead: ['Et si c’était'], accent: ['la bonne ?'] },
      link: 'Retrouver AVYOR',
      tagline: 'La création fait la rencontre.',
      ...
      product: 'Un produit Shavod.',
      audience: 'Creators × Marques',
      top: 'Retour en haut ↑',
    },
    news: {
      label: 'News',
      intro: 'Des conseils concrets pour mieux collaborer. Les nouveautés AVYOR pour avancer.',
      metaTitle: 'News AVYOR — conseils pour les Creators et les marques',
      metaDescription:
        'Guides pratiques pour préparer une collaboration, créer du contenu, choisir un partenaire et suivre les résultats, et nouveautés vérifiées de l’application AVYOR.',
      eyebrow: 'NEWS',
      featured: 'À la une',
      latestEyebrow: 'NEWS',
      latestTitle: 'Dernières publications',
      latestLink: 'Toutes les publications',
      searchLabel: 'Rechercher un article',
      searchPlaceholder: 'Brief, portfolio, première collaboration…',
      submit: 'Rechercher',
      audienceLabel: 'Public',
      themeLabel: 'Thématique',
      all: 'Tous',
      audiences: { brands: 'Marques', creators: 'Creators', both: 'Creators et marques' },
      themes: {
        prepare: 'Préparer une collaboration',
        create: 'Créer du contenu',
        choose: 'Choisir un partenaire',
        measure: 'Suivre les résultats',
      },
      types: { guide: 'Guide pratique', product: 'Nouveauté AVYOR', case: 'Retour d’expérience' },
      results: (count) =>
        count === 0 ? 'Aucun article' : count === 1 ? '1 article' : `${count} articles`,
      empty: 'Aucun article ne correspond à ces critères pour le moment.',
      reset: 'Effacer la recherche et les filtres',
      loading: 'Recherche en cours…',
      error: 'Les articles n’ont pas pu être chargés. Vérifiez votre connexion.',
      retry: 'Réessayer',
      ...
      sources: 'Sources',
      accessed: 'consultée le',
      related: 'À lire ensuite',
      sectionLink: 'Lien vers la section',
      feed: 'Flux RSS des News AVYOR',
      callouts: { example: 'Exemple', checklist: 'À vérifier', warning: 'Point d’attention' },
      dateLocale: 'fr-FR',
    },
    llms: {
      stores: 'Consultez la page de téléchargement pour les plateformes disponibles.',
      storesPending:
        'Le lancement public se prépare. Aucun lien de store non vérifié n’est publié.',
      demo: 'Les captures contiennent des données de démonstration.',
      pages: 'Pages officielles',
      contact: 'Contact',
      languages: 'Ce site est publié dans plusieurs langues',
    },
    page: {
    ...
    notFound: {
      ...
      metaTitle: 'Page introuvable — AVYOR',
      metaDescription:
        'Cette page AVYOR est introuvable. Retrouvez les parcours Creators et marques depuis la page d’accueil.',
      eyebrow: '404 — HORS CHAMP',
      title: 'Cette page n’est plus dans le cadre.',
      lead: 'Cette adresse ne mène à aucune page d’AVYOR.',
      leadAt: ['L’adresse ', ' ne mène à aucune page d’AVYOR.'],
      suggestion: 'Vous cherchiez peut-être',
      back: 'Revenir à l’accueil',
      report: 'Signaler un lien cassé',
      destinationsLabel: 'Pages principales',
      destinationsEyebrow: 'OU REPARTEZ D’ICI',
    },
    legal: {
      updated: 'Dernière mise à jour :',
      tocLabel: 'Sur cette page',
      tocTitle: 'SUR CETTE PAGE',
      noticeTitle: 'Document en préparation pour le lancement.',
      notice: (pending) =>
        `${pending} section${pending > 1 ? 's' : ''} attend${pending > 1 ? 'ent' : ''} une information que l’éditeur doit fournir. Elles sont signalées dans le texte plutôt que complétées par approximation.`,
      todoLabel: 'À compléter avant publication :',
      contactTitle: 'Nous écrire',
      contactLead: 'Pour toute question relative à ce document :',
      crosslinks: 'Documents liés',
    },
  },
};
